# Простое веб-приложение на JavaScript, которое отображает список задач (To-Do List). Приложение должно позволять добавлять новые задачи, помечать задачи как выполненные и удалять задачи.
